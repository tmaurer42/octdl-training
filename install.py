...
def install_centralized():
    ...
    if os_name == 'Linux':
        ...
        subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'torch==1.13.1+cu116', 'torchvision==0.14.1+cu116', '--extra-index-url', 'https://download.pytorch.org/whl/cu116'])
...
def install_federated():
    subprocess.check_call([sys.executable, '-m', 'pip', 'install', 'plato-learn'])
